...
class AdministratorServices extends React.Component {
  state = {
    open: true,
  };
...
AdministratorServices.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AdministratorServices);